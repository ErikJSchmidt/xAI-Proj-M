...
from models import Plain18Layer, accuracy, evaluate, fit, get_default_device, DeviceDataLoader, to_device
...
def load_dataset_and_train_cnn(data_dir, store_model_dir):
    ...
    history = fit(20, lr, model, device_aware_train_data_loader, device_aware_validation_data_loader, opt_func)
    print(history)
